...
dtype = "'건의'"
comment_cnt = "0"
content = "'건의게시판내용1123123412313512'"
...
for i in range(1, 51):
    title = "'건의게시판제목"
    title = title + str(i) + "'"    
    curs.execute(f"insert into user (dtype, type, comment_count, content, create_date, title, view_count) values ({dtype}, {dtype}, {comment_cnt}, {content}, {create_date}, {title}, {view_cnt})")
